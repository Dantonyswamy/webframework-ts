...
exports.User = void 0; //Define an interface that contracts the properties for a User object

var axios_1 = __importDefault(require("axios"));

var Eventing_1 = require("./Eventing"); //using composition we bring the instance of Eventing class into the User class
...
function () {
  ...
  User.prototype.fetch = function () {
    ...
    axios_1.default.get(" http://localhost:3000/user/" + this.get('id')).then(function (response) {
  ...
  User.prototype.save = function () {
    ...
    if (id) {
      axios_1.default.put("http://localhost:3000/user/" + id, this.data);
    } else {
